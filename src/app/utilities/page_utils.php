...
/**
 *  throws a 404 error. Sets headers, etc.
 *
 *  @return    void
 */
    function throw_404(){
...
/**
 *  if file exists, will map URI to a php page (in /pages)
 *
 *  @return    boolean    true if URI is mappable
 */
...
/**
 *  returns value from an array generated by ini file
 *
 *  @param     string    $key             key to search
 *  @param     array     $global_array    array to use
 *  @param     array     $page_array      array to override (if no key, will use $global_array)
 *  @return    string                     value found (empty if none)
 */
...
/**
 *  returns string formatted to use as header tags in <head>
 *
 *  @param     string    $meta_tag        meta tag to generate
 *  @param     string    $key             key to search
 *  @param     array     $global_array    array to use
 *  @param     array     $page_array      array to override (if no key, will use $global_array)
...
/**
 *  parses config/pages.ini to create <head>
 *
 *  @return    string    meta tags, etc.
 */
...
/**
 *  parses config/pages.ini to create <footer>
 *
 *  @return    string    js scripts, etc.
 */
...
/**
 *  returns bootstrap class to show which page is live and whether user is logged in
 *
 *  @param     string    $page_name    [description]
...
/**
 *  checks whether page needs authentication, and if so whether user is logged in
 *
 *  @return    boolean    true if script can stop as page is served
 */
